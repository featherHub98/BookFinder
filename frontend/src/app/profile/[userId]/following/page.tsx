...
import { ArrowLeft, User, UserPlus, UserCheck, Loader2 } from 'lucide-react';
...
export default function FollowingPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const followingResult = await bookApi.getFollowing(userId, 1, 50);
        ...
        <CardHeader>
          ...
          {user && (
            <p className="text-sm text-muted-foreground">
              People {user.name || 'this user'} is following
            </p>
          )}
        </CardHeader>
        <CardContent>
